...
* [Haskell 98 FFI Addendum](haskell-98-ffi-addendum.pdf)
* https://hackage.haskell.org/package/base-4.11.01.0/docs/Foreign.html
...
* http://somerby.net/mack/crosslink/
* https://en.wikibooks.org/wiki/Haskell/FFI
* https://downloads.haskell.org/~ghc/master/users-guide/utils.html#writing-haskell-interfaces-to-c-code-hsc2hs
